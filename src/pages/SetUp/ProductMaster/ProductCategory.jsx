  ...
  const handleAdd = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${apiUrl}/product/addProductCategory`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${Token}`,
...
const handleEdit = async (event) => {
    ...
    try {
        const response = await axios.put(
            `${apiUrl}/product/update-product-category`,
            {
                id: formData.id,
                name: formData.name
            },
  ...
  const handleDelete = async (e) => {
    ...
    try {
     const response = await axios.delete(
        `${apiUrl}/product/delete-productcategory/${productCategoryDetails.id}`,
        {   
          headers: {
            Authorization: `Bearer ${Token}`,
          },
        ...
        <div className="content">
          <div className="row">
            <div className="col-md-12">
              {/* Page Header */}
              <PageHeader title="Product Category" count={totalPages} />
              {/* /Page Header */}
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Add New Product Category</h5>
              <button
                className="btn-close"
