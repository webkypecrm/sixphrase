      ...
      const handleAdd = async (e) => {
        ...
        try {
          const response = await axios.post(
            `${apiUrl}/product/addProductBrand`,
            formData,
            {
              headers: {
                Authorization: `Bearer ${Token}`,
      ...
      const handleEdit = async (event) => {
          ...
          try {
              const response = await axios.put(
                  `${apiUrl}/product/updateProductBrand/${productCategoryDetails.id}`,
                  {
                      name: formData.name
                  },
                  {
              ...
              setFormData(initialForm);
              fetchData();
              toast.success('Product brand edited successfully!');
          } catch (error) {
              const errorMessage =
      ...
      const handleDelete = async (e) => {
        ...
        try {
         const response = await axios.delete(
            `${apiUrl}/product/deleteProductBrand/${productCategoryDetails.id}`,
            {   
              headers: {
                Authorization: `Bearer ${Token}`,
              },
     ...
     <Fragment>
            ...
            <div className="content">
              <div className="row">
                <div className="col-md-12">
                  {/* Page Header */}
                  <PageHeader title="Product Brands" count={totalPages} />
                  {/* /Page Header */}
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Add New Product Brand</h5>
                  <button
                    className="btn-close"
                  ...
                  <form onSubmit={handleAdd}>
                    <div className="form-wrap">
                      <label className="col-form-label">
                        Product Brand Name <span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control"
          ...
          <div className="modal custom-modal fade" id="edit_source" role="dialog">
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Edit Product Brand</h5>
                  <button
                    className="btn-close"
                    data-bs-dismiss="modal"
                    aria-label="Close"
