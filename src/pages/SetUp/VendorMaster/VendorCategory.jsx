...
const VendorCategory = () => {
    ...
    // console.log('VendorCategoryDetails =>', VendorCategoryDetails, num1++)
    ...
    const handleAdd = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/add-vendor-category`, {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to add vendor category');
            }
    ...
    const handleEdit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/edit-vendor-category`, {
                method: 'PUT',
                headers: {
                    Authorization: `Bearer ${Token}`
                },
            ...
            setFormData(initialForm)
            fetchData()
            toast.success('Vendor category edited successfully!');
    ...
    const handleDelete = async (event) => {
        event.preventDefault();
        try {
            const response = await fetch(`${apiUrl}/master/delete-vendor-category/${vendorCategoryDetails.id}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${Token}`
                }
                ...
                <div className="dropdown table-action">
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        <Link
                            ...
                            onClick={() => {
                                setVendorCategoryDetails(record)
        ...
        <div>
                ...
                <div className="content">
                    <div className="row">
                        <div className="col-md-12">
                            {/* Page Header */}
                            <PageHeader title="Vendor Category" count={totalPages} />
                            {/* /Page Header */}
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Add New Vendor Category</h5>
                            <button
                                className="btn-close"
                            ...
                            <form onSubmit={handleAdd}>
                                ...
                                <div className="form-wrap">
                                    <label className="col-form-label">
                                        Vendor Category Name <span className="text-danger">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        className="form-control"
                                ...
                                <p style={{ fontSize: 'small', color: '#7695FF' }}>Note: You can add multiple vendors at once by separating them with commas (,)</p>
            ...
            <div className="modal custom-modal fade" id="edit_source" role="dialog">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Edit Vendor Category</h5>
                            <button
                                className="btn-close"
                                data-bs-dismiss="modal"
                                aria-label="Close"
