...
const SupportCategory = () => {
  ...
  const [supportCategoryDetails, setSupportCategoryDetails] = useState({});
  ...
  const handleAdd = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${apiUrl}/master/add-support-category`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${Token}`,
      ...
      fetchData();
      toast.success(
        response.data.message || "SupportCRM category added successfully!"
      );
    } catch (error) {
  ...
  const handleEdit = async (event) => {
    ...
    try {
      const response = await axios.put(
        `${apiUrl}/master/edit-support-category`,
        {
          id: formData.id,
          name: formData.name,
        },
      ...
      fetchData();
      toast.success(
        response.data.message || "SupportCRM category edited successfully!"
      );
    } catch (error) {
      const errorMessage =
  ...
  const handleDelete = async (e) => {
    ...
    try {
      const response = await axios.delete(
        `${apiUrl}/master/delete-support-category/${supportCategoryDetails.id}`,
        {
          headers: {
            Authorization: `Bearer ${Token}`,
          },
      ...
      setSupportCategoryDetails({});
      fetchData();
      toast.success(
        response.data.message || "SupportCRM category deleted successfully!"
      );
    } catch (error) {
      const message =
        ...
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            <Link
              ...
              onClick={() => setSupportCategoryDetails(record)}
            >
    ...
    <Fragment>
        ...
        <div className="content">
          <div className="row">
            <div className="col-md-12">
              {/* Page Header */}
              <PageHeader title="SupportCRM Category" count={totalPages} />
              {/* /Page Header */}
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Add New SupportCRM Category</h5>
              <button
                className="btn-close"
      ...
      <div className="modal custom-modal fade" id="edit_source" role="dialog">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Edit SupportCRM Category</h5>
              <button
                className="btn-close"
                data-bs-dismiss="modal"
                aria-label="Close"
            ...
            <div className="modal-body">
              <form>
                <div className="success-message text-center">
                  ...
                  <h3>Remove SupportCRM Category?</h3>
