...
const LeadFor = () => {
    ...
    const handleEdit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/master/edit-category`, {
                method: 'PUT',
                headers: {
                    Authorization: `Bearer ${Token}`
                },
            ...
            const resData = await response.json();
            if (!response.ok) {
                throw new Error(resData.message || 'Failed to edit');
            }
    ...
    const handleDelete = async (event) => {
        event.preventDefault();
        try {
            const response = await fetch(`${apiUrl}/master/delete-lead-for/${departmentDetails.id}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${Token}`
                }
        ...
        <div>
                ...
                <div className="content">
                    <div className="row">
                        <div className="col-md-12">
                            {/* Page Header */}
                            <PageHeader title="Requirement" count={totalPages} />
                            {/* /Page Header */}
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleAdd}>
                                ...
                                <p style={{ fontSize: 'small', color: '#7695FF' }}>Note: You can add multiple Requirement at once by separating them with commas (,)</p>
            ...
            <div className="modal custom-modal fade" id="edit_source" role="dialog">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Edit Requirement</h5>
                            <button
                                className="btn-close"
                                data-bs-dismiss="modal"
                                aria-label="Close"
