  ...
  const handleAdd = async (e) => {
      ...
      try {
        const response = await axios.post(
          `${apiUrl}/product/addservice-category`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${Token}`,
    ...
    const handleEdit = async (event) => {
        ...
        try {
            const response = await axios.put(
                `${apiUrl}/product/update-service-category`,
                {
                    id: formData.id,
                    name: formData.name
                },
      ...
      const handleDelete = async (e) => {
        ...
        try {
         const response = await axios.delete(
            `${apiUrl}/product/delete-service-category/${serviceCategoryDetails.id}`,
            {   
              headers: {
                Authorization: `Bearer ${Token}`,
              },
          ...
          <div className="dropdown table-action">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              <Link
                ...
                onClick={() => {
                  setServiceCategoryDetails(record);
              ...
              <Link
                ...
                onClick={() => setServiceCategoryDetails(record)}
              >
            ...
            <div className="content">
              <div className="row">
                <div className="col-md-12">
                  {/* Page Header */}
                  <PageHeader title="Service Category" count={totalPages} />
                  {/* /Page Header */}
                ...
                <div className="modal-body">
                  <form onSubmit={handleAdd}>
                    ...
                    <p style={{ fontSize: "small", color: "#7695FF" }}>
                      Note: You can add multiple service at once by separating them
                      with commas (,)
                    </p>
