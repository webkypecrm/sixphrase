...
const ManageLeadList = lazy(() =>
  import("../../components/Sales/ManageLeadList")
);
  ...
  const fetchLeadData = async (page) => {
    try {
      ...
      let url = `${apiUrl}/lead/lead-list?page=${
        page ? page : 1
      }&pageSize=${pageSize}&to=${to}&from=${from} &industry=${industry}&source=${source}&country=${country}&state=${state}&city=${city}&stage=${stage}&leadOwner=${leadOwner}&assignedTo=${assignedTo}&leadFor=${leadFor}&search=${search}&categoryId=${categoryId}`;
            ...
            <div className="col-md-12">
              ...
              <div className="card main-card">
                <div className="card-body">
                  ...
                  {/* /Search */}
                  <Suspense
                    fallback={data.length > 0 ? <ContentLoader /> : <Empty />}
                  >
                    <ManageLeadList
                      data={data}
