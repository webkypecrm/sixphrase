...
import ManageCustomerList from "../../components/Reports/Sales/ManageCustomerList";
import SearchSection from "../../components/Reports/Sales/SearchSection";
...
const SalesReportsData = () => {
  ...
  const fetchCustomerData = async (page) => {
    try {
      ...
      let url = `${apiUrl}/customer/lead-service-list?page=${page ? page : 1}&pageSize=${pageSize}&to=${to}&from=${from}&industry=${industry}&source=${source}&country=${country}&stage=${stage}&company=${company}&customerOwner=${customerOwner}&leadFor=${leadFor}&search=${search}`
...
export default SalesReportsData