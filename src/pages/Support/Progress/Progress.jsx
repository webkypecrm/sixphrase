...
import ProgressSupportSearch from "./ProgressSupportSearch";
...
const Progress = () => {
      ...
      // Get ticket details
        ...
        const getticketData = async () => {
          try {
            const response = await axios.get(
              `${apiUrl}/product/support-ticket-list?status=Progress`,
              {
                headers: {
                  Authorization: `Bearer ${Token}`,
                },
        ...
        <div className="content">
          <div className="row">
            <div className="col-md-12">
              {/* Page Header */}
              <PageHeader title="In Progress Ticket" count={count} />
              {/* /Page Header */}
              {/* Campaign Status */}
              {/* <CampaignStatus /> */}
              {/* /Campaign Status */}
