...
import AddTicket from "../../components/Support/AddTicket";
...
const ManageTicket = () => {
  ...
  const getticketData = async () => {
    try {
      const response = await axios.get(
        `${apiUrl}/product/support-ticket-list?status=`,
        {
          headers: {
            Authorization: `Bearer ${Token}`,
          },
...
const getAllTicketData = async () => {
  try {
    const response = await axios.get(`${apiUrl}/product/support-ticket-list`, {
      headers: {
        Authorization: `Bearer ${Token}`,
      },
    });
    ...
    setAllTicketData(formattedData);

    console.log("Fetched & formatted tickets:", formattedData);
  } catch (error) {
        ...
        <div className="content">
          <div className="row">
            <div className="col-md-12">
              {/* Page Header */}
              <PageHeader title="Ticket" count={count} />
              {/* /Page Header */}
              {/* Campaign Status */}
              {/* <CampaignStatus /> */}
              {/* /Campaign Status */}
