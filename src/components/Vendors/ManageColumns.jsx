              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-lead_id"
                    className="check"
                    checked={manageColumns['Vendor Id']}
                    onChange={() => handleManageColumns('Vendor Id')}
                  />
                  <label
                    htmlFor="col-lead_id"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-name_1"
                    className="check"
                    checked={manageColumns['Contact Person']}
                    onChange={() => handleManageColumns('Contact Person')}
                  />
                  <label
                    htmlFor="col-name_1"
                    className="checktoggle"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-name_2"
                    className="check"
                    checked={manageColumns['Contact Email']}
                    onChange={() => handleManageColumns('Contact Email')}
                  />
                  <label
                    htmlFor="col-name_2"
                    className="checktoggle"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-name_3"
                    className="check"
                    checked={manageColumns['Contact Number']}
                    onChange={() => handleManageColumns('Contact Number')}
                  />
                  <label
                    htmlFor="col-name_3"
                    className="checktoggle"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-name"
                    className="check"
                    checked={manageColumns['Vendor Name']}
                    onChange={() => handleManageColumns('Vendor Name')}
                  />
                  <label
                    htmlFor="col-name"
                    className="checktoggle"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-email"
                    className="check"
                    checked={manageColumns['Vendor Email']}
                    onChange={() => handleManageColumns('Vendor Email')}
                  />
                  <label
                    htmlFor="col-email"
                    className="checktoggle"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-mobile1"
                    className="check"
                    checked={manageColumns['Vendor Mobile1']}
                    onChange={() => handleManageColumns('Vendor Mobile1')}
                  />
                  <label
                    htmlFor="col-mobile1"
                    className="checktoggle"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-mobile2"
                    className="check"
                    checked={manageColumns['Vendor Mobile2']}
                    onChange={() => handleManageColumns('Vendor Mobile2')}
                  />
                  <label
                    htmlFor="col-mobile2"
                    className="checktoggle"
              ...
              <li>
                ...
                <div className="status-toggle">
                  <input
                    ...
                    id="col-mobile3"
                    className="check"
                    checked={manageColumns['Vendor Mobile3']}
                    onChange={() => handleManageColumns('Vendor Mobile3')}
                  />
                  <label
                    htmlFor="col-mobile3"
                    className="checktoggle"
