...
const SearchSection = ({
    ...
    const handleCustomerExport = async () => {
        try {
            ...
            let url = `${apiUrl}/customer/export-customer-reports?&to=${to}&from=${from}&industry=${industry}&source=${source}&country=${country}&stage=${stage}&company=${company}&customerOwner=${customerOwner}&leadFor=${leadFor}&search=${search}`
