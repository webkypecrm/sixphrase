...
const ManageLeadList = ({
    ...
    let columns = [
        ...
        {
            title: "Paid Expense Id",
            dataIndex: "id",
            key: "id",
            render: (text, record) => {
                return <Link to={`/sales/vendor-details/${record?.paidExpenseId}`}
        ...
        },
        {
            ...
            render: (text, record) => {
                ...
                >
                    ...
                    <ul>
                        <li>{record?.Expense?.VendorCategory?.name || ''}</li>
                    </ul>
                </Link >
            }
        },
        {
            ...
            render: (text, record) => {
                ...
                >
                    ...
                    <ul>
                        <li>{record?.Expense?.VendorSubCategory?.name || ''}</li>
                    </ul>
                </Link >
            }
        },
        ...
        },
        {
            ...
            render: (text, record) => {
                ...
                >
                    ...
                    <ul>
                        <li>{record?.Expense?.Vendor?.vendorName.slice(0, 15) || ''}</li>
                    </ul>
                </Link >
            }
        },
        {
            ...
            render: (text, record) => {
                return <Link to={`/sales/vendor-details/${record?.expenseId}`}
                    className="table-avatar d-flex align-items-center">
                    <ul>
                        <li>{record?.Expense?.payableAmount}</li>
                    </ul>
                </Link>
            }
        },
        ...
        },
        {
            ...
            render: (text, record) => {
                return <div className="table-avatar d-flex align-items-center">
                    <ul>
                        <li>{record?.Expense?.totalPayable}</li>
                    </ul>
                </div>
            }
        },
        ...
        },
        {
            ...
            key: "id",
            render: (text, record) => {
                return <Link to={`${record?.uploadProofUrl}`} className="table-avatar d-flex align-items-center">
                    <span className="company-img menu-list-icon ">
    ...
    return (
        <>
            <div className="table-responsive custom-table">
                ...
                />
               Total Payment: <span>₹{totalAmount || 0}</span>
            </div>
