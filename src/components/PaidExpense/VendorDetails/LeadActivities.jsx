            ...
            <div className={`col-xl-${open ? '9' : '12'}`}>
                <div className="contact-tab-wrap">
                    <ul className="contact-nav nav">
                        ...
                        {data?.Customer[0]?.customerId &&
                            <li>
                                <Link to="#" data-bs-toggle="tab" data-bs-target="#payment-history">
                    ...
                    <div className="tab-content pt-0">
                            ...
                            <div className="contact-activity">
                                ...
                                {Object.keys(groupActivityByDate).map((date) =>
                                    <div key={date}>
                                        ...
                                        <ul>
                                            {groupActivityByDate[`${date}`].map((lead) => <li className={lead.type == 'fileUpdate' || lead.type == 'meetingUpdate' || lead.type == 'appointment' || lead.type == 'callUpdate' ? "" : "activity-wrap"} key={lead.id} style={{ marginBottom: '1rem' }}>
                                                                        ...
                                                                        {callData[0]?.id !== lead?.id && lead?.status !== 'Done' ?
                                                                            <p>
                                                                                <del style={{ color: 'red' }}><span>{lead?.staff?.name}</span> <strong> {lead?.status.toLowerCase()} </strong>
                                                                                    a call on {getDate(lead.callBackDate)}, {formatTimeToAmPm(lead.callBackTime)} </del>
                                                                            </p>
                                                                            :
                                                                            <p style={{ color: 'green' }}>
                                                                                <span>{lead?.staff?.name}</span> <strong> {lead?.status.toLowerCase()} </strong>
                                                                                a call on {getDate(lead.callBackDate)}, {formatTimeToAmPm(lead.callBackTime)}
                                                                            </p>
                                                                        }
                                                ...
                                                }
                                                {
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="activity-info">
                                                            <h6 style={{ margin: '0px' }}>  Invoice was created by
                                                                ...
                                                                <span style={{ display: "block" }}>{lead?.staff?.name.split(' ')[0]}</span>
                                                            </h6>
                                                            <span className="badge-day" style={{ fontSize: 'x-small', margin: '0', maxWidth: '8rem', }}>{getDate(lead?.createdAt)},{getTime(lead?.createdAt)}</span>

                                                            <p style={{ marginTop: '10px' }}  >Notes - {lead?.comment}</p>
                                                        </div>
                                                    </>
                                                }
                                                {
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="activity-info">
                                                            <h6 style={{ margin: '0px' }}>  Comment was posted by
                                                                <span className="avatar-xs">
                                                                    <img
                                                                        src={lead?.staff?.profilePicUrl}
                                                                        alt="img"
                                                            ...
                                                            <span className="badge-day" style={{ fontSize: 'x-small', margin: '0', maxWidth: '8rem', }}>{getDate(lead?.createdAt)},{getTime(lead?.createdAt)}</span>
                                                            <p style={{ marginTop: '10px' }}>{lead?.comment}</p>
                                                ...
                                                }
                                                {
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="activity-info" >
                                                            <h6 style={{ margin: '0px' }}>Services was added by
                                                                <span className="avatar-xs">
                                                                    <img
                                                                        src={lead?.staff?.profilePicUrl}
                                                                        alt="img"
                                                            ...
                                                            <div style={{ display: 'flex', gap: '20px', marginTop: '10px' }}>
                                                                <ul>
                                                                    ...
                                                                    <li>Discount: {lead?.discountPercentage ? lead?.discountPercentage : 0}%</li>
                                                                    <li>Amount to pay: ₹{lead?.estimateCost}</li>
                                                                    {/* <li>{lead?.createdAtTime}</li> */}
                                                                </ul>
                                                                <p style={{ width: open ? "30rem" : "42.5rem" }}>
                                                                    <ReactQuill
                                                                        value={lead?.LeadService?.remark ? lead?.LeadService?.remark : lead?.comment}
                                                                        theme="snow"
                                                                        readOnly={true}
                                                                        ...
                                                                        <div className="file-info">
                                                                            <div className="file-user" >
                                                                                ...
                                                                                <div style={{ display: 'grid' }}>
                                                                                    ...
                                                                                    <p className="badge-day" style={{ fontSize: 'x-small', margin: '0', maxWidth: '8rem' }}>
                                                                            ...
                                                                            <ul>
                                                                                <li> Comment:{" "} {lead?.leadDocument?.comment}</li>
                                                                                <li> File Type: {" "}
                                                            ...
                                                            <div className="calls-box" >
                                                                <div className="caller-info">
                                                                    <div className="calls-user">
                                                                        ...
                                                                        />
                                                                        <div style={{ display: 'grid' }}>
                                                                            {appointmentData[0]?.id !== lead?.id && lead?.status !== 'Done' ?
                                                                                <del style={{ color: 'red' }}><p>
                                                                    ...
                                                                    <div className="row" style={{ display: 'flex' }}>
                                                                        <div className="col-sm-4">
                                                                            ...
                                                                            <div className="dropdown">
                                                                                <Link
                                                                                    ...
                                                                                    aria-expanded="false"
                                                                                >
                                                                                    {lead?.LeadFor?.name ? lead?.LeadFor?.name.toUpperCase() : ""}
                                                                                </Link>
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-sm-4">
                                                                        ...
                                                                        <div className="col-sm-4">
                                                                            ...
                                                                            <div className="dropdown">
                                                                                ...
                                                                                >
                                                                                    <i className="ti ti-square-rounded-filled me-1 text-success circle" />
                                                                                    {lead?.lastCallSummary ? 'Join Link' : 'N/A'}
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                }
                                                {
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="activity-info">
                                                            <h6 style={{ margin: '0px' }}>  Payment was updated by
                                                                <span className="avatar-xs">
                                                                    <img
                                                                        src={lead?.staff?.profilePicUrl}
                                                                        alt="img"
                                                    ...
                                                    <>
                                                        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                                                            <p style={{ color: "green", margin: 0 }}>
                                                                ...
                                                                a meeting on {getDate(data?.meetingDate)}, {convertToAmPm(data?.meetingTime)}
                                                            </p>
                                                            <OverlayTrigger
                                                                placement="bottom"
                                                                overlay={<Tooltip id="mark-meeting-tooltip">Remind me</Tooltip>}
                                            ...
                                            <div className="col-sm-4">
                                                ...
                                                <div className="dropdown">
                                                    <Link
                                                        ...
                                                        aria-expanded="false"
                                                    >
                                                        {data?.LeadFor?.name ? data?.LeadFor?.name.toUpperCase() : ""}
                                                    </Link>
                                            ...
                                            <div className="file-info">
                                                <div className="file-user" >
                                                    ...
                                                    <div style={{ display: 'grid' }}>
                                                        ...
                                                        <p className="badge-day" style={{ fontSize: 'x-small', margin: '0', maxWidth: '8rem' }}>{getDate(file?.leadDocument?.createdAt)},{getTime(file?.leadDocument?.createdAt)}</p>
                                                    </div>
                                                </div>
                        ...
                        <div className="tab-pane fade" id="services">
                            ...
                            <div className="notes-activity">
                                ...
                                {servicesData.map((data) => <div className="calls-box" key={data.id}>
                                    <div className="caller-info">
                                        <div className="calls-user">
                                            <img
                                                src={data?.staff?.profilePicUrl}
                                    ...
                                    <div style={{ display: 'flex', gap: '20px', marginTop: '10px' }} >
                                        <ul >
                                            ...
                                            <li>Discount: {data?.discountPercentage ? data?.discountPercentage : 0}%</li>
                                            <li>Amount to pay : ₹{data?.estimateCost}</li>
                                            <li>{data?.createdAtTime}</li>
                                        </ul>
                                        <p style={{ width: "42.5rem" }}>
                                            <ReactQuill
                                                value={data?.LeadService?.remark ? data?.LeadService?.remark : data?.comment}
                                                theme="snow"
                                                readOnly={true}
                                                modules={{ toolbar: false }}
                                            />
