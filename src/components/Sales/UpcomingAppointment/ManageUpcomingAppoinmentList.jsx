    ...
    // },
    {
      ...
      render: (text, record) => {
        return (
          <Link
            to={
              record?.lead?.assignedTo == staffId || staffType == "1"
                ? `/sales/leads-details/${record?.leadId}`
                : "#"
            }
    ...
    },
    {
      ...
      render: (text, record) => {
        return (
          ...
          >
            <ul>
              <li>{getDate(record?.meetingDate)} </li>
            </ul>
          </Link>
        );
      },
    },
    {
      ...
      render: (text, record) => {
        return (
          ...
          >
            <ul>
              <li>{getTime(record?.meetingTime)}</li>
            </ul>
          </Link>
        );
      },
    },
    {
      ...
      render: (text, record) => {
        return (
          ...
          >
            <ul>
              <li>{getDate(record?.createdAt)} </li>
            </ul>
          </Link>
        );
      },
    },
    {
      ...
      render: (text, record) => {
        return (
          ...
          >
            <ul>
              <li>{getTime(record?.createdAt)}</li>
            </ul>
          </Link>
        );
      },
          ...
          <ul>
            ...
            <li>
              ...
              >
                <ul>
                  <li>
                    <strong>Source:</strong> {record?.lead?.source?.name}
                  </li>
                </ul>
              </Link>
            </li>
    ...
    // },
    {
      ...
      render: (text, record) => (
        <>
          <Link>
            <span
              className="badge bg-outline-dark text-dark"
              style={{ cursor: "none" }}
            >
              {record?.status}
            </span>
          ...
          {record?.status !== "Done" &&
            ...
            record?.lead?.assignedTo == staffId && (
